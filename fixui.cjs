...
c = c.replace(/\{\/\*\s*Month Selector Box\s*\*\/\}\r?\n\s*<div className="relative cursor-pointer">[\s\S]*?<\/select>\r?\n\s*<\/div>/,
            {/* Selectors Row */}
