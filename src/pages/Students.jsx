        ...
        <div className="space-y-3.5 pt-1">
          {filteredStudents.map((student) => {
            ...
            return (
              <div 
                key={student.id} 
                className="bg-white dark:bg-[#111522] rounded-[24px] border border-zinc-200/80 dark:border-zinc-800/80 p-3 shadow-sm hover:shadow-md transition-all group overflow-hidden"
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  >
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-11 h-11 rounded-2xl p-[2px] bg-gradient-to-tr from-red-600 via-rose-500 to-amber-500 flex items-center justify-center shadow-sm">
                      ...
                      {student.status === 'Active' && (
                        <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full bg-emerald-500 border-2 border-white dark:border-[#111522]" />
                      )}
                    </div>

                    <div className="min-w-0 flex-1">
                      <h3 className="text-[15px] font-heading font-extrabold text-zinc-900 dark:text-white capitalize truncate tracking-tight">
                        {student.name}
                      </h3>
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 text-[10px] font-bold truncate max-w-[80px]">
                          {student.batchName || 'General'}
                        </span>
                        <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400">
                          ₹{student.monthlyFee || student.fees || 0}/mo
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    <button
                      type="button"
                      onClick={() => navigate(`/students/${student.id}`)}
                      className="p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/80 text-zinc-600 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-zinc-50 dark:bg-zinc-800/80 text-blue-600 dark:text-blue-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors active:scale-95"
                    >
                ...
                {/* App Credentials Pass - Ultra Compact */}
                <div className="mt-3 flex items-center justify-between bg-zinc-50 dark:bg-[#0a0d15] rounded-xl p-2.5 border border-zinc-200/70 dark:border-zinc-800/80">
                  <div className="flex flex-col gap-1 min-w-0 flex-1">
                    <div className="flex items-center space-x-1.5 text-[10px] text-zinc-500 dark:text-zinc-400 font-medium truncate">
                  ...
                  <div className="flex flex-col gap-1 items-end ml-2 flex-shrink-0">
                    <button
                      ...
                      className="text-zinc-400 hover:text-emerald-500 p-1 rounded-md transition-colors h-5 flex items-center justify-center"
                    >
                    ...
                    <button
                      ...
                      className="text-zinc-400 hover:text-red-500 p-1 transition-colors h-5 flex items-center justify-center"
                    >
