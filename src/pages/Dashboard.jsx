      ...
      <CardContent className="p-4 sm:p-6">
        <div className="flex items-start sm:items-center justify-between">
          <div>
            ...
            <p className="mt-1 sm:mt-2 text-2xl sm:text-4xl font-heading font-bold text-zinc-900 dark:text-white tracking-tight">
              {value}
            </p>
          </div>
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      {/* ========================================================================= */}
      <div className="block md:hidden pb-36 px-4 space-y-4 pt-6">
          ...
          >
            ...
            <div className="mt-2">
              ...
              <p className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-0.5 mt-0.5 truncate">
                <TrendingUp className="w-3 h-3 inline flex-shrink-0" />{" "}
                  ...
                  {upcomingClasses.map((c) => {
                    ...
                    if (c.batchId && typeof c.batchId === "object") {
                      ...
                      const foundBatch = batches.find(
                        (b) => b.id === c.batchId || b._id === c.batchId,
                      );
                    ...
                    return (
                      <div
                        key={c.id || c._id}
                        className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 p-4 bg-gray-50/80 dark:bg-[#030303]/80 backdrop-blur-2xl rounded-lg border border-black/5 dark:border-white/5"
                      >
                        <div className="flex items-start sm:items-center space-x-3 sm:space-x-4">
                          <div className="p-2 sm:p-3 bg-white dark:bg-zinc-900/40 backdrop-blur-xl rounded-md shadow-sm dark:shadow-md shadow-black/5 dark:shadow-black/40 border border-zinc-100 dark:border-white/5 text-center min-w-[65px] sm:min-w-[70px]">
                            <div className="text-[10px] sm:text-xs font-semibold text-red-500 uppercase">
                              TIME
                            </div>
                            <div className="text-sm font-heading font-bold text-zinc-900 dark:text-white tracking-tight">
                              {c.time || "N/A"}
                            </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="text-sm sm:text-base font-heading font-semibold text-zinc-900 dark:text-white tracking-tight truncate">
                            ...
                            <div className="flex flex-wrap items-center mt-1 text-xs sm:text-sm text-zinc-500 dark:text-zinc-400 gap-x-3 gap-y-1">
                              <span className="flex items-center whitespace-nowrap">
                                <BookOpen className="w-3 h-3 mr-1" /> Batch:{" "}
                                {batchName}
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="flex sm:flex-col gap-2">
                          {c.status === "Completed" ? (
                            <Badge
                              variant="success"
                              className="bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400 justify-center"
                            >
                              Completed
                            </Badge>
                          ) : (
                            <Badge
                              variant="secondary"
                              className="bg-zinc-100 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-300 justify-center"
                            >
                              Upcoming
                            </Badge>
                          )}
                    ...
                    {recentActivity.slice(0, 5).map((activity, activityIdx) => (
                      <li key={activity._id || activityIdx}>
                        <div className="relative pb-8">
                          {activityIdx !==
                          Math.min(recentActivity.length, 5) - 1 ? (
                            <span
